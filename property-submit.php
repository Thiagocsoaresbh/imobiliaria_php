...
<script type="text/javascript">
	...
	function validateAllSteps(){
	   ...
	   if(!isStepValid){
		  $('#wizard').smartWizard('showMessage','Corrija os erros para continuar');
	   } else{
	...
	function validateSteps(step){
	  ...
	  if(step == 1){
		 if(validateStep1() == false ){
			isStepValid = false; 
			$('#wizard').smartWizard('showMessage','<font style="color:#F00;">Corrija os erros no passo'+step+ ' e clique para avançar.</font>');
      ...
      function validateStep2(){
		  ...
		  if(!appmt_name && appmt_name.length <= 0){
			 isValid = false;
			 $('#msg_appmt_name').html('<font style="color:#F00;">&nbsp;&nbsp;Digite o nome do imóvel.</font>').show();
		  }else{
		  ...
		  if(!appmt_type_id && appmt_type_id <= 0){
			 isValid = false;
			 $('#msg_addr1').html('<font style="color:#F00;">&nbsp;&nbsp;Digite o endereço.</font>').show();
		  }else{
			 $('#msg_addr1').html('').show();
			 isValid = true;
		  }
		  ...
		  if(!acity && acity.length <= 0){
			 isValid = false;
			 $('#msg_acity').html('<font style="color:#F00;">&nbsp;&nbsp;Digite a cidade.</font>').show();
		  }else{
			 $('#msg_acity').html('').show();
			 isValid = true;
		  }
		  ...
		  if(!arent && arent <= 0){
			 isValid = false;
			 $('#msg_arent').html('<font style="color:#F00;">&nbsp;&nbsp;Digite o valor do imóvel.</font>').show();
		  }else{
			 $('#msg_arent').html('').show();
			 isValid = true;
		  }
	   ...
	   // Validate Email
		  ...
		  if(!emai && emai.length <= 0){
			 ...
			 if( !isValidEmailAddress(emai) ){
				 isValid = false; 
				 $('#msg_email').html('<font style="color:#F00;">Corrija o endereço de e-mail</font>').show();
			 } else{
				 isValid = true;
			 }
		  }        
		...
		// Validate Username
		   ...
		   if(!un && un.length <= 0){
			 isValid = false;
			 $('#msg_username').html('<font style="color:#F00;">Digite seu primeiro nome</font>').show();
		   }else{
		...
		// validate Last Name
		   ...
		   if(!sname && sname.length <= 0){
			 isValid = false;
			 $('#msg_lastname').html('<font style="color:#F00;">Digite o sobrenome completo</font>').show();
		   }else{
		...
		function validateStep3(){
		  ...
		  if($("#tos1").attr("checked")==true){
			  ...
			  isValid = false;
			  $('#msg_tos1').html('<font style="color:#F00;">Digite os termos e condições</font>').show();
		  }
...
<div id="container-div">
  <div id="container-inside">
    <h1 class="col2">Registro de imóvel</h1>
            ...
            <div id="wizard" class="swMain">
              <ul>
                <li><a href="#step-1">
                  ...
                  <small>Preencha os dados da conta</small> </span> </a></li>
                <li><a href="#step-2">
                  <label class="stepNumber">2</label>
                  <span class="stepDesc"> Dados do imóvel<br />
                  <small>Preencha os dados</small> </span> </a></li>
                ...
                <li><a href="#step-3">
                  ...
                  <small>Você ainda não terminou</small> </span> </a></li>
                <?php } ?>
              </ul>
              <div id="step-1">
                ...
                <table cellpadding="5" cellspacing="2" border="0">
                  ...
                  <tr>
                    <td align="left"><strong>Primeiro Nome:</strong></td>
              ...
              <div id="step-2">
                <h2 class="StepTitle">Step 2: Detalhes do imóvel</h2>
                <!--*****************************************************************************************************************-->
                ...
                <table cellpadding="5" cellspacing="5" border="0" width="100%">
                  ...
                  <tr>
                    <td><strong>Endereço 2:</strong></td>
              ...
              <div id="step-3">
                ...
                <table cellspacing="3" cellpadding="3" align="left" width="100%">
                  ...
                  <tr>
                    <td align="left"><input type="checkbox" name="tos" id="tos1" />
                      Para continuar, aceite os termos e condições.&nbsp;&nbsp;<span id="msg_tos1"></span></td>
                  </tr>
                </table>
                <?php }else{ ?>
                ...
                <table cellspacing="3" cellpadding="3" align="left" width="100%">
                  ...
                  <tr>
                    <td ><strong>Listagem de valores:</strong></td>
