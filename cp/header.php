...
<div id="top">
  <div id="top-inside">
    <div id="bsi-addmin-text">Painel de Administração</div>
    <div class=" top-link_last"><a href="logout.php">Sair</a></div>
    <div class=" top-link"><a href="change_password.php">Mudar Senha</a></div>
    <div class=" top-link"><a href="admin-home.php">Início</a></div>
  </div>
</div>
<div id="con">
<div id="container">
