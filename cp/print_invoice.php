...
<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px;"><b>Phone:</b> <?php echo $bsiCore->config['conf_apartment_phone'];?></span><br />

<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px;"><b>Fax:</b> <?php echo $bsiCore->config['conf_apartment_fax'];?></span><br />
