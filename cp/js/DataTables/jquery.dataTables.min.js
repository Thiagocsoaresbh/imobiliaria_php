...
sLengthMenu:"Mostra _MENU_ entradas",sZeroRecords:"Sem registros",sEmptyTable:"Sem dados na tabela",sInfo:"mostrando _START_ de _END_ de _TOTAL_ entradas",sInfoEmpty:"mostrando 0 de 0 de 0 entradas",sInfoFiltered:"(filtrando _MAX_ total de entradas)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"Primeiro",sPrevious:"Anterior",sNext:"Próximo",sLast:"Último"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=
