...
$.extend($.validator, {
	...
	messages: {
		...
		creditcard: "Número inválido de cartão de crédito.",
		equalTo: "Digite o mesmo valor novamente.",
		accept: "Extensão inválida.",
		maxlength: $.validator.format("Digite pelo menos {0} caracteres."),
		minlength: $.validator.format("Digite no máximo {0} caracteres."),
